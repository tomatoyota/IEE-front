...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///Users/yafong/Documents/sys/CIEE/IEE-front/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/yafong/Documents/sys/CIEE/IEE-front/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/yafong/Documents/sys/CIEE/IEE-front/node_modules/devalue/index.js';
import destr from 'file:///Users/yafong/Documents/sys/CIEE/IEE-front/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///Users/yafong/Documents/sys/CIEE/IEE-front/node_modules/ufo/dist/index.mjs';
import { hash } from 'file:///Users/yafong/Documents/sys/CIEE/IEE-front/node_modules/ohash/dist/index.mjs';
import { propsToString, renderSSRHead } from 'file:///Users/yafong/Documents/sys/CIEE/IEE-front/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/yafong/Documents/sys/CIEE/IEE-front/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/yafong/Documents/sys/CIEE/IEE-front/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/yafong/Documents/sys/CIEE/IEE-front/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Users/yafong/Documents/sys/CIEE/IEE-front/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/yafong/Documents/sys/CIEE/IEE-front/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/yafong/Documents/sys/CIEE/IEE-front/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///Users/yafong/Documents/sys/CIEE/IEE-front/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/yafong/Documents/sys/CIEE/IEE-front/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/yafong/Documents/sys/CIEE/IEE-front/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/yafong/Documents/sys/CIEE/IEE-front/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///Users/yafong/Documents/sys/CIEE/IEE-front/node_modules/unctx/dist/index.mjs';
import { isVNode, version, unref } from 'file:///Users/yafong/Documents/sys/CIEE/IEE-front/node_modules/vue/index.mjs';
import { basename } from 'file:///Users/yafong/Documents/sys/CIEE/IEE-front/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///Users/yafong/node_modules/@iconify/utils/lib/index.mjs';
import { collections } from 'file:///Users/yafong/Documents/sys/CIEE/IEE-front/.nuxt/nuxt-icon-server-bundle.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///Users/yafong/Documents/sys/CIEE/IEE-front/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/yafong/Documents/sys/CIEE/IEE-front/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/yafong/Documents/sys/CIEE/IEE-front/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/yafong/Documents/sys/CIEE/IEE-front","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/yafong/Documents/sys/CIEE/IEE-front/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/yafong/Documents/sys/CIEE/IEE-front/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/yafong/Documents/sys/CIEE/IEE-front/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/yafong/Documents/sys/CIEE/IEE-front/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _6uWTlgKMXn = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/yafong/Documents/sys/CIEE/IEE-front";
...
const _hCGdEh = defineCachedEventHandler(async (ctx) => {
...
const _lazy_e5AhCM = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_e5AhCM, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _hCGdEh, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_e5AhCM, lazy: true, middleware: false, method: undefined }
];
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"中國電機工程學會"},{"property":"og:title","content":"中國電機工程學會"},{"property":"og:description","content":"中國電機工程學會"}],"link":[],"style":[],"script":[],"noscript":[],"title":"中國電機工程學會"};
...
const getClientManifest = () => import('file:///Users/yafong/Documents/sys/CIEE/IEE-front/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
